...
public class TilesPanel extends Base2DFramework implements ActionListener {
	...
	private void createAssets(int amount) {
		...
		for (int i = 0; i < amount; i++) {
			...
			Asset asset = new Asset(null, AssetType.TILE, grid, primaryColor, Color.decode(ColorUtils.getRandomColour()));
